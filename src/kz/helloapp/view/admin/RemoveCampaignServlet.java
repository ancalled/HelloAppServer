...
import kz.helloapp.view.partner.PartnerServlet;
...
public class RemoveCampaignServlet extends PartnerServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (camp != null) {
            resp.sendRedirect(ctx + "admin/view/campaigns?mess=camp-deleted&camp=" + camp.getTitle());
            return;
        }
        resp.sendRedirect(ctx + "admin/view/campaigns?mess=camp-not-deleted");
    }
}
